...
if ( ! function_exists( 'include_setup' ) ) :
	...
	function include_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'include' ),
		) );
...
function include_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'include' ),
...
function include_scripts() {
	...
	wp_enqueue_script( 'include-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'include-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
